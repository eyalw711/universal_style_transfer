...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.13\linewidth}
		\includegraphics[width=\linewidth]{reconst_exper/dec_bridge_original.png} % original num.1	
	\end{subfigure}
	\begin{subfigure}[b]{0.13\linewidth}
	...
	\centering
	\begin{subfigure}[b]{0.13\linewidth}
		\includegraphics[width=\linewidth]{reconst_exper/dec_giraffe_original.png} % original num.1	
	\end{subfigure}
	\begin{subfigure}[b]{0.13\linewidth}
	...
	\centering
	\begin{subfigure}[b]{0.13\linewidth}
		\includegraphics[width=\linewidth]{reconst_exper/dec_in1_original.png} % original num.1	
	\end{subfigure}
	\begin{subfigure}[b]{0.13\linewidth}
	...
	\centering
	\begin{subfigure}[b]{0.13\linewidth}
		\includegraphics[width=\linewidth]{reconst_exper/dec_in2_original.png} % original num.1	
	\end{subfigure}
	\begin{subfigure}[b]{0.13\linewidth}
	...
	\centering
	\begin{subfigure}[b]{0.13\linewidth}
		\includegraphics[width=\linewidth]{reconst_exper/dec_giraffe_original.png} % original num.5
		\caption{Original}
	\end{subfigure}
	\begin{subfigure}[b]{0.13\linewidth}
